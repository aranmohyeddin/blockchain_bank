...
--------------------+------------------------------+------------+------------+------------+----------+-------------+-------------
 ...
 public             | django_migrations            | dns        |            | t          | f        | f           | f
 pg_catalog         | pg_authid                    | postgres   | pg_global  | t          | f        | f           | f
 public             | banking_banksettings         | dns        |            | t          | f        | f           | f
 ...
 public             | banking_manager              | dns        |            | t          | f        | t           | f
 ...
 public             | banking_bank                 | dns        |            | t          | f        | t           | f
 public             | banking_wallet               | dns        |            | t          | f        | t           | f
 public             | banking_customer             | dns        |            | t          | f        | t           | f
 public             | blockchain_sequence          | dns        |            | t          | f        | f           | f
 information_schema | sql_features                 | postgres   |            | f          | f        | f           | f
 information_schema | sql_implementation_info      | postgres   |            | f          | f        | f           | f
 public             | blockchain_transaction       | dns        |            | t          | f        | t           | f
 ...
 public             | blockchain_transactionoutput | dns        |            | t          | f        | t           | f
 public             | blockchain_transactioninput  | dns        |            | t          | f        | t           | f
 public             | blockchain_blockchain        | dns        |            | t          | f        | t           | f
 public             | blockchain_block             | dns        |            | t          | f        | t           | f
(73 rows)
